...
export const VoiceAssistantElevenlabs: React.FC<VoiceAssistantElevenLabsProps> = ({ 
  ...
  // Send mode switch command when responseMode changes
  useEffect(() => {
    if (isConnected && responseMode !== lastResponseMode.current) {
      const modeMessage = responseMode === 'overview' 
        ? 'switch to overview mode'
        : 'switch to conversation mode';
      
      // Send mode switch command to agent
      sendTextMessage(modeMessage);
      lastResponseMode.current = responseMode;
  ...
  }, [responseMode, isConnected, sendTextMessage]);
